...
const logger_config_1 = require("../../../../src/infrastructure/logging/logger.config");
...
describe('WinstonLogger', () => {
    ...
    describe('Constructor', () => {
        it('should initialize with development settings', () => {
            logger = tsyringe_1.container.resolve(WinstonLogger_1.WinstonLogger);
            expect(winston_1.default.createLogger).toHaveBeenCalledWith({
                level: 'debug',
                format: logger_config_1.LogFormats.developmentFormat,
        ...
        it('should initialize with production settings and CloudWatch', () => {
            ...
            expect(winston_1.default.createLogger).toHaveBeenCalledWith({
                level: 'info',
                format: logger_config_1.LogFormats.productionFormat,
                transports: [expect.any(Object)]
            });
    ...
    describe('Logging Methods', () => {
        ...
        it('should log error messages with Error object', () => {
            ...
            expect(mockLoggerInstance.error).toHaveBeenCalledWith(message, Object.assign(Object.assign({}, meta), { error: {
                    name: error.name,
